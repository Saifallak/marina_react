...
const {t} = useTranslation()
  return (
    <PageComponent styles={styles} title={CurrentCatalouge.name[locale]} hero={img.src}>
      <div
...
export async function getStaticPaths() {
  const res = await fetch('https://admin.marina.com.eg/api/data/catalog_types?with_catalogs=1')
...
export const getStaticProps = async (context) => {
  ...
  const res2 = await fetch('https://admin.marina.com.eg/api/data/catalog_types?with_catalogs=1')
